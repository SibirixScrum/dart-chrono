 ...
 void main() {
   test("Test - Single Expression", () {
     ...
     testSingleCase(chrono.casual, "The Deadline is last Friday...",
     ...
     testSingleCase(chrono.casual, "The Deadline is past Friday...",
         new Date (2012, 7, 9), (result) {
           expect(result.index).toBe(16);
     ...
     testSingleCase(chrono.casual, "Let's have a meeting on Friday next week",
     ...
     testSingleCase(
         chrono.casual, "I plan on taking the day off on Tuesday, next week",
   ...
   test("Test - Weekday casual `This` guessing", () {
     testSingleCase(
         chrono.casual, "This Saturday", new Date ("Tue Aug 2 2022"), (result) {
       expect(result.start.get("day")).toBe(6);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("year")).toBe(2022);
     });
     testSingleCase(
         chrono.casual, "This Sunday", new Date ("Tue Aug 2 2022"), (result) {
       expect(result.start.get("day")).toBe(7);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("year")).toBe(2022);
     });
     testSingleCase(
         chrono.casual, "This Wednesday", new Date ("Tue Aug 2 2022"), (
         result) {
       expect(result.start.get("day")).toBe(3);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("year")).toBe(2022);
     ...
     testSingleCase(
         chrono.casual, "This Saturday", new Date ("Sun Aug 7 2022"), (result) {
       expect(result.start.get("day")).toBe(13);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("year")).toBe(2022);
     });
     testSingleCase(
         chrono.casual, "This Sunday", new Date ("Sun Aug 7 2022"), (result) {
       expect(result.start.get("day")).toBe(7);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("year")).toBe(2022);
     });
     testSingleCase(
         chrono.casual, "This Wednesday", new Date ("Sun Aug 7 2022"), (
         result) {
   ...
   test("Test - Weekday casual `Last` guessing", () {
     testSingleCase(
         chrono.casual, "Last Saturday", new Date ("Tue Aug 2 2022"), (result) {
       expect(result.start.get("day")).toBe(30);
       expect(result.start.get("month")).toBe(7);
       expect(result.start.get("year")).toBe(2022);
     });
     testSingleCase(
         chrono.casual, "Last Sunday", new Date ("Tue Aug 2 2022"), (result) {
       expect(result.start.get("day")).toBe(31);
       expect(result.start.get("month")).toBe(7);
       expect(result.start.get("year")).toBe(2022);
     });
     testSingleCase(
         chrono.casual, "Last Wednesday", new Date ("Tue Aug 2 2022"), (
         result) {
   ...
   test("Test - Weekday With Casual Time", () {
     testSingleCase(chrono.casual, "Lets meet on Tuesday morning",
         new Date (2015, 3, 18), (result) {
   ...
   test("Test - Weekday Overlap", () {
     testSingleCase(
         chrono.casual, "Sunday, December 7, 2014", new Date (2012, 7, 9), (
         result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono.casual, "Sunday 12/7/2014", new Date (2012, 7, 9), (result) {
       expect(result.index).toBe(0);
   ...
   test("Test - Weekday range", () {
     testSingleCase(
         chrono.casual, "Friday to Monday", new Date (2023, 4 - 1, 9), (
         result) {
     ...
     testSingleCase(
         chrono.casual, "Monday to Friday", new Date (2023, 4 - 1, 9), (
         result) {
       expect(result.start.get("year")).toBe(2023);
       expect(result.start.get("month")).toBe(4);
       expect(result.start.get("day")).toBe(10);
   ...
   test("Test - forward dates only option", () {
     testSingleCase(
         chrono.casual, "Monday (forward dates only)", new Date (2012, 7, 9),
     ...
     testSingleCase(
         chrono.casual, "this Friday to this Monday", new Date (2016, 8 - 1, 4),
         { "forwardDate": true}, (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono.casual, "sunday morning", new Date ("August 15, 2021, 20:00"),
         { "forwardDate": true}, (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(chrono.casual, "vacation monday - friday",
