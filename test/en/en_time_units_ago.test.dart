 ...
 void main() {
   test("Test - Single Expression", () {
     testSingleCase(
         chrono, "5 days ago, we did something", new Date (2012, 7, 10), (
         result) {
     ...
     testSingleCase(
         chrono, "10 days ago, we did something", new Date (2012, 7, 10), (
         result) {
       expect(result.start).not.toBeNull();
       expect(result.start.get("year")).toBe(2012);
     ...
     testSingleCase(
         chrono, "15 minute ago", new Date (2012, 7, 10, 12, 14), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "15 minute earlier", new Date (2012, 7, 10, 12, 14), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "15 minute before", new Date (2012, 7, 10, 12, 14), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "   12 hours ago", new Date (2012, 7, 10, 12, 14), (result) {
     ...
     testSingleCase(
         chrono, "1hr ago", new Date (2012, 7, 10, 12, 14), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "   half an hour ago", new Date (2012, 7, 10, 12, 14), (
         result) {
       expect(result.index).toBe(3);
     ...
     testSingleCase(chrono, "12 hours ago I did something",
     ...
     testSingleCase(chrono, "12 seconds ago I did something",
         new Date (2012, 7, 10, 12, 14), (result) {
           expect(result.index).toBe(0);
     ...
     testSingleCase(chrono, "three seconds ago I did something",
         new Date (2012, 7, 10, 12, 14), (result) {
           expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "A days ago, we did something", new Date (2012, 7, 10), (
         result) {
       expect(result.start).not.toBeNull();
       expect(result.start.get("year")).toBe(2012);
       expect(result.start.get("month")).toBe(8);
     ...
     testSingleCase(
         chrono, "a min before", new Date (2012, 7, 10, 12, 14), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "the min before", new Date (2012, 7, 10, 12, 14), (result) {
       expect(result.index).toBe(0);
   ...
   test("Test - Single Expression (Casual)", () {
     testSingleCase(chrono, "5 months ago, we did something",
     ...
     testSingleCase(
         chrono, "5 years ago, we did something", new Date (2012, 8 - 1, 10), (
         result) {
       expect(result.start).not.toBeNull();
     ...
     testSingleCase(
         chrono, "a week ago, we did something", new Date (2012, 8 - 1, 3), (
         result) {
       expect(result.start).not.toBeNull();
       expect(result.start.get("year")).toBe(2012);
       expect(result.start.get("month")).toBe(7);
     ...
     testSingleCase(chrono, "a few days ago, we did something",
   ...
   test("Test - Nested time ago", () {
     testSingleCase(
         chrono, "15 hours 29 min ago", new Date (2012, 7, 10, 22, 30), (
         result) {
     ...
     testSingleCase(
         chrono, "1 day 21 hours ago ", new Date (2012, 7, 10, 22, 30), (
         result) {
     ...
     testSingleCase(
         chrono, "1d 21 h 25m ago ", new Date (2012, 7, 10, 22, 30), (result) {
     ...
     testSingleCase(
         chrono, "3 min 49 sec ago ", new Date (2012, 7, 10, 22, 30), (result) {
     ...
     testSingleCase(
         chrono, "3m 49s ago ", new Date (2012, 7, 10, 22, 30), (result) {
   ...
   test("Test - Before with reference", () {
     testSingleCase(
         chrono, "2 day before today", new Date (2012, 7, 10), (result) {
       expect(result.start.get("year")).toBe(2012);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("day")).toBe(8);
     });
     testSingleCase(
         chrono, "the day before yesterday", new Date (2012, 7, 10), (result) {
       expect(result.start.get("year")).toBe(2012);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("day")).toBe(8);
     });
     testSingleCase(
         chrono, "2 day before yesterday", new Date (2012, 7, 10), (result) {
       expect(result.start.get("year")).toBe(2012);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("day")).toBe(7);
     });
     testSingleCase(
         chrono, "a week before yesterday", new Date (2012, 7, 10), (result) {
       expect(result.start.get("year")).toBe(2012);
       expect(result.start.get("month")).toBe(8);
   ...
   test("Test - Strict mode", () {
     testSingleCase(
         chrono.strict, "5 minutes ago", new Date (2012, 7, 10, 12, 14), (
         result, text) {
       expect(result.start.get("hour")).toBe(12);
     ...
     testUnexpectedResult(
         chrono.strict, "5m ago", new Date (2012, 7, 10, 12, 14));
     testUnexpectedResult(
         chrono.strict, "5hr before", new Date (2012, 7, 10, 12, 14));
     testUnexpectedResult(
         chrono.strict, "5 h ago", new Date (2012, 7, 10, 12, 14));
   });
