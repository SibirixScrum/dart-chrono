...
import '../test_util.dart';
 ...
 void main() {
   test("Test - Single expression", () {
     testSingleCase(en.casual, "10 August 2012", new Date (2012, 7, 10), (result) {
     ...
     testSingleCase(en.casual, "3rd Feb 82", new Date (2012, 7, 10), (result) {
       expect(result.start).not.toBeNull();
     ...
     testSingleCase(en.casual, "Sun 15Sep", new Date (2013, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         en.casual, "The Deadline is 10 August", new Date (2012, 7, 10), (result) {
     ...
     testSingleCase(en.casual, "The Deadline is Tuesday, 10 January",
     ...
     testSingleCase(
         en.casual, "The Deadline is Tue, 10 January", new Date (2012, 7, 10), (
         result) {
       expect(result.index).toBe(16);
     ...
     testSingleCase(
         en.casual, "31st March, 2016", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         en.casual, "23rd february, 2016", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
   ...
   test("Test - Single expression with separators", () {
     testSingleCase(
         en.casual, "10-August 2012", new Date (2012, 7, 8), (result, text) {
   ...
   test("Test - Range expression", () {
     testSingleCase(
         en.casual, "10 - 22 August 2012", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         en.casual, "10 to 22 August 2012", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         en.casual, "10 August - 12 September", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         en.casual, "10 August - 12 September 2013", new Date (2012, 7, 10), (
         result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         en.casual, " 17 August 2013 to 19 August 2013", new Date (2012, 7, 10), (
         result) {
   ...
   test("Test - Combined expression", () {
     testSingleCase(
         en.casual, "12th of July at 19:00", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(en.casual, "5 May 12:00", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(en.casual, "7 May 11:00", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
   ...
   test("Test - Ordinal Words", () {
     testSingleCase(
         en.casual, "Twenty-fourth of May", new Date (2012, 7, 10), (result) {
     ...
     testSingleCase(
         en.casual, "Eighth to eleventh May 2010", new Date (2012, 7, 10), (
         result) {
   ...
   test("Test - little endian date followed by time", () {
     testSingleCase(
         en.casual, "24th October, 9 am", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         en.casual, "24th October, 9 pm", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         en.casual, "24 October, 9 pm", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         en.casual, "24 October, 9 p.m.", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         en.casual, "24 October 10 o clock", new Date (2017, 7 - 1, 7, 15), (
         result) {
   ...
   test("Test - year 90's parsing", () {
     testSingleCase(en.casual, "03 Aug 96", new Date (2012, 7, 10), (result) {
       expect(result.text).toBe("03 Aug 96");
       expect(result.start.get("year")).toBe(1996);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("day")).toBe(3);
     });
     testSingleCase(en.casual, "3 Aug 96", new Date (2012, 7, 10), (result) {
       expect(result.text).toBe("3 Aug 96");
       expect(result.start.get("year")).toBe(1996);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("day")).toBe(3);
     });
     testSingleCase(en.casual, "9 Aug 96", new Date (2012, 7, 10), (result) {
   ...
   test("Test - Forward Option", () {
     testSingleCase(
         en.casual.casual, "22-23 Feb at 7pm", new Date (2016, 3 - 1, 15), (
         result) {
       expect(result.start.get("year")).toBe(2016);
       expect(result.start.get("month")).toBe(2);
     ...
     testSingleCase(en.casual, "17 August 2013 - 19 August 2013", (result) {
       expect(result.start.get("year")).toBe(2013);
       expect(result.start.get("month")).toBe(8);
       expect(result.start.get("day")).toBe(17);
       expect(result.end.get("year")).toBe(2013);
   ...
   test("Test - Impossible Dates (Strict Mode)", () {
     testUnexpectedResult(
         en.casual.strict, "32 August 2014", new Date (2012, 7, 10));
     testUnexpectedResult(
         en.casual.strict, "29 February 2014", new Date (2012, 7, 10));
     testUnexpectedResult(en.casual.strict, "32 August", new Date (2012, 7, 10));
     testUnexpectedResult(en.casual.strict, "29 February", new Date (2013, 7, 10));
   });
 }