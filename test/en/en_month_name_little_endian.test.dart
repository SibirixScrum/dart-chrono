 ...
 void main() {
   test("Test - Single expression", () {
     ...
     testSingleCase(
         chrono, "The Deadline is 10 August", new Date (2012, 7, 10), (result) {
     ...
     testSingleCase(chrono, "The Deadline is Tuesday, 10 January",
     ...
     testSingleCase(
         chrono, "The Deadline is Tue, 10 January", new Date (2012, 7, 10), (
         result) {
       expect(result.index).toBe(16);
     ...
     testSingleCase(
         chrono, "31st March, 2016", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "23rd february, 2016", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
   ...
   test("Test - Single expression with separators", () {
     testSingleCase(
         chrono, "10-August 2012", new Date (2012, 7, 8), (result, text) {
   ...
   test("Test - Range expression", () {
     testSingleCase(
         chrono, "10 - 22 August 2012", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "10 to 22 August 2012", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "10 August - 12 September", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, "10 August - 12 September 2013", new Date (2012, 7, 10), (
         result) {
       expect(result.index).toBe(0);
     ...
     testSingleCase(
         chrono, " 17 August 2013 to 19 August 2013", new Date (2012, 7, 10), (
         result) {
   ...
   test("Test - Combined expression", () {
     testSingleCase(
         chrono, "12th of July at 19:00", new Date (2012, 7, 10), (result) {
       expect(result.index).toBe(0);
   ...
   test("Test - Ordinal Words", () {
     testSingleCase(
         chrono, "Twenty-fourth of May", new Date (2012, 7, 10), (result) {
     ...
     testSingleCase(
         chrono, "Eighth to eleventh May 2010", new Date (2012, 7, 10), (
         result) {
   ...
   test("Test - little endian date followed by time", () {
     testSingleCase(
         chrono, "24th October, 9 am", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         chrono, "24th October, 9 pm", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         chrono, "24 October, 9 pm", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         chrono, "24 October, 9 p.m.", new Date (2017, 7 - 1, 7, 15), (result) {
     ...
     testSingleCase(
         chrono, "24 October 10 o clock", new Date (2017, 7 - 1, 7, 15), (
         result) {
   ...
   test("Test - Forward Option", () {
     testSingleCase(
         chrono.casual, "22-23 Feb at 7pm", new Date (2016, 3 - 1, 15), (
         result) {
       expect(result.start.get("year")).toBe(2016);
       expect(result.start.get("month")).toBe(2);
   ...
   test("Test - Impossible Dates (Strict Mode)", () {
     testUnexpectedResult(
         chrono.strict, "32 August 2014", new Date (2012, 7, 10));
     testUnexpectedResult(
         chrono.strict, "29 February 2014", new Date (2012, 7, 10));
