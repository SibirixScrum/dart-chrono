...
import '../test_util.dart';
 ...
 void main() {
   test("Test - Skip random non-date patterns", () {
     ...
     testUnexpectedResult(en.casual, "Total: \$1,194.09 [image: View Reservation");
     testUnexpectedResult(en.casual, "at 6.5 kilograms");
     testUnexpectedResult(
         en.casual, "ah that is unusual", null, forwardDate: true);
   });
   test("Test - URLs % encoded", () {
     testUnexpectedResult(en.casual, "%e7%b7%8a");
     testUnexpectedResult(en.casual,
   ...
   test("Test - Date with version number pattern", () {
     testSingleCase(en.casual.en, "1.5.3 - 2015-09-24", (result) {
       expect(result.text).toBe("2015-09-24");
     });
     testSingleCase(en.casual.en, "1.5.30 - 2015-09-24", (result) {
       expect(result.text).toBe("2015-09-24");
     });
     testSingleCase(en.casual.en, "1.50.30 - 2015-09-24", (result) {
       expect(result.text).toBe("2015-09-24");
     });
   });
 }