 import "../test_util.dart" show testSingleCase , testUnexpectedResult ; import "../../src.dart" as chrono ;
 ...
 void main() {
   test("Test - Single Expression Start with Year", () {
     ...
     testSingleCase(
         chrono, "The Deadline is 2012/8/10", new Date (2012, 7, 10), (result) {
   ...
   test("Test - Single Expression Start with Year and Month Name", () {
     ...
     testSingleCase(
         chrono, "The Deadline is 2012/aug/10", new Date (2012, 7, 10), (
         result) {
       expect(result.index).toBe(16);
       expect(result.text).toBe("2012/aug/10");
       expect(result.start).toBeDate(new Date (2012, 8 - 1, 10, 12));
     ...
     testSingleCase(
         chrono, "The Deadline is 2018 March 18", new Date (2012, 7, 10), (
         result) {
       expect(result.index).toBe(16);
