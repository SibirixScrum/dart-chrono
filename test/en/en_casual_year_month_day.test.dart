...
import '../test_util.dart';
 void main() {
   test("Test - Single Expression Start with Year", () {
    ...
    testSingleCase(en.casual.strict, "2014/2/28",
        (ParsedResult result, String text) {
      expect(result.text, "2014/2/28");
    });
    testSingleCase(en.casual.strict, "2014/12/28",
        (ParsedResult result, String text) {
      expect(result.text, "2014/12/28");
      expect(result).toBeDate(DateTime(2014, 12 - 1, 28, 12));
    });
    testSingleCase(en.casual.strict, "2014.12.28",
        (ParsedResult result, String text) {
      expect(result.text, "2014.12.28");
   ...
   test("Test - Single Expression Start with Year and Month Name", () {
    ...
    testSingleCase(
      ...
      expect(result).toBeDate(DateTime(2018, 3 - 1, 18, 12));
    });
   });
