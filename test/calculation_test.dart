...
void main() {
  test("Test - This Weekday Calculation", () {
    {
      ...
      expect(output.date(),new DateTime("Mon, Aug 22 2022 12:00:00"));
    }
    {
      final reference =
      ...
      expect(output.date(),new DateTime("Fri, Aug 26 2022 12:00:00"));
    }
    {
      final reference =
      ...
      expect(output.date(),new DateTime("Sun, Aug 7 2022 12:00:00"));
    }
  });
  test("Test - Last Weekday Calculation", () {
    {
      ...
      expect(output.date(),new DateTime("Fri, Aug 19 2022 12:00:00"));
    }
    {
      final reference =
          new ReferenceWithTimezone(new DateTime("Sat, 20 Aug 2022 12:00:00"));
      ...
      expect(output.date(),new DateTime("Mon, Aug 15 2022 12:00:00"));
    }
    {
      final reference =
          new ReferenceWithTimezone(new DateTime("Sat, 20 Aug 2022 12:00:00"));
      ...
      expect(output.date(),new DateTime("Sun, Aug 14 2022 12:00:00"));
    }
    {
      final reference =
          new ReferenceWithTimezone(new DateTime("Sat, 20 Aug 2022 12:00:00"));
      ...
      expect(output.date(),new DateTime("Sat, Aug 13 2022 12:00:00"));
    }
  });
  test("Test - Next Weekday Calculation", () {
    ...
    }
    {
      ...
      expect(output.date(),new DateTime("Sat, Aug 27 2022 12:00:00"));
    }
    {
      final reference =
          new ReferenceWithTimezone(new DateTime("Sun, Aug 21 2022 12:00:00"));
      ...
      expect(output.date(),new DateTime("Sun, Aug 28 2022 12:00:00"));
    }
    {
      final reference =
    ...
    }
    {
      ...
      final output =
          createParsingComponentsAtWeekday(reference, Weekday.MONDAY, "next");
      expect(output.date,new DateTime("Mon, Aug 8 2022 12:00:00"));
    }
    {
      final reference =
          new ReferenceWithTimezone(new DateTime("Tue, Aug 2 2022 12:00:00"));
      final output =
          createParsingComponentsAtWeekday(reference, Weekday.FRIDAY, "next");
      expect(output.date(),new DateTime("Fri, Aug 12 2022 12:00:00"));
    }
    {
      final reference =
          new ReferenceWithTimezone(new DateTime("Tue, Aug 2 2022 12:00:00"));
